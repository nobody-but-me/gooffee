...
export default function DeTodosOsMales() {
    return (
	<>
	    <Tree 
		_image={_book}
		...
		_text={
			...
			<p>
				...
				<p>
				    An important note to do: the title "De Todos os Males, o Melhor que Poderia Acontecer" is stolen from a <a>Gabriel Orling</a> song. I liked the title. 
				</p>
				<br />
				<p>
				    -- --
