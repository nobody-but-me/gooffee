...
function ListLink({_text, _path}) {
    return <a href={_path}>{_text}</a>;
}
...
function RoomContent({_title, _text}) {
	...
	<div className="room_content">
		...
		<div className="text_justify card">
		    <ul>
			<li><color className='most-recent-log'>[ 08/09/2025 Log ]</color>: Two years;</li>
			<li><color className='log'>[ 06/06/2025 Log ]</color>: I interviewed the Dr. Jingmai O'Connor(06/03/2025) and Alexander Clark(06/06/2025) for my article;</li>
